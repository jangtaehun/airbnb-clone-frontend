import {
  ...
  export default function UploadRoom() {
    ...
    const mutation = useMutation({mutationFn:uploadRoom,
    ...
    const { data: amenities } = useQuery<IAmenity[]>({queryKey:["amenities"], queryFn: getAmenities});
    console.log(amenities)
    const { data: categories } = useQuery<ICategory[]>(
        {queryKey:["categories"], queryFn: getCategory}
    );
    useHostOnlyPage();
    console.log(watch())
